...
int Const::index = -1, Const::ops = -1, Const::query_num = -1, Const::series_num = -1, Const::k = -1, Const::visited_node_num = -1, Const::dtw_window_size = -1;
double Const::search_ratio = 0;
